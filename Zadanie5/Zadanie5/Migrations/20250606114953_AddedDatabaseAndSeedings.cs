    ...
    public partial class AddedDatabaseAndSeedings : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Prescription_Medicament", x => new { x.IdMedicament, x.IdPrecription });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Prescription_Medicament_Prescription_IdPrecription",
                        column: x => x.IdPrecription,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "john.meyer@gmail.com", "John", "Meyer" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(1990, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Raiden", "Gaines" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Prescription_Medicament_IdPrecription",
                table: "Prescription_Medicament",
                column: "IdPrecription");
        }
